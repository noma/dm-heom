...
circular_dichroism_config::circular_dichroism_config(const std::string& config_file_name, bool parse_config)
...
void circular_dichroism_config::check()
{
...
void circular_dichroism_config::check_final()
{
	// check program_task_
	if (program_task() != program_task_t::CIRCULAR_DICHROISM)
		throw config_error("wrong program_task for this application");
}

void circular_dichroism_config::post_process()
{
